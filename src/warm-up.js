...
//guessing this 'stockCount' variable should still be using 'inStock' ??
if (inStock >= 1) {
...
const vegetables = ['carrots','broccoli','potatoes','zucchini','cucumber']
...
// different fruits.
const fruits = ['strawberries','blueberries','oranges','bananas','pineapple']
...
//could also add things like location, numberOfCheckouts, and hasGasStation
